    ...
    <>
      <div className="flex justify-between items-center bg-primary_card px-4 py-2 m-3 rounded-xl">
        ...
        <div className="w-1/3 hidden md:flex md:justify-center">
          <ul>
            <li className="inline mr-6 cursor-pointer hover:text-secondary">
              <Link to="/">Bulk Minting</Link>
            </li>
            <li className="inline mr-6 cursor-pointer hover:text-secondary">
          ...
          {typeof window.ethereum !== "undefined" ? (
            wallet?.address ? (
              <button
                ...
                className="bg-bord border-l-4 border-b-2 border-bg_button md:px-12 px-4 py-2 mr-3 rounded-xl font-semibold"
              >
              ...
              <button
                ...
                className="bg-bord border-l-4 border-b-2 border-bg_button md:px-12 px-4 py-2 mr-3 rounded-xl"
              >
                Connect
              </button>
            )
